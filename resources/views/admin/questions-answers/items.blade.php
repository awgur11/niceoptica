...
@include('layouts.admin.header', ['title' => 'Часто задаваемые вопросы', 'content' => 'Блок "Часто задоваемые вопросы" на главной странице сайта'])
...
@include('layouts.admin.form.form-input', ['title' => 'Вопрос', 'name' => 'title', 'value' => NULL])

@include('layouts.admin.form.form-textarea', ['title' => 'Ответ', 'name' => 'text1', 'editor' => 'tinymce'])
