...
@include('layouts.admin.header', ['title' => __('Items'), 'content' => __('Items list')])
...
@else
  @foreach($items as $ki => $item)
          <tr id="item-{{$item->id }}" >
            ...
            <td>
              <select name="nol2" id="nol2" class="change-select-ajax form-control" data-id="{{ $item->id }}" data-table="items" data-column="nol2">
                <option value="">empty</option>
                <option value="123" @if($item->nol2 == '123') selected @endif>select 123</option>
                <option value="456" @if($item->nol2 == '456') selected @endif>select 456</option>
              </select>
            </td>
            <td class="text-left">
              <div class="form-check">
                <label class="form-check-label">
                  <input type="radio" name="nol3{{ $item->id }}[]" class="change-radio-ajax" data-id="{{ $item->id }}" data-table="items" data-column="nol3" value="yes" @if($item->nol3 == 'yes') checked @endif> yes
                </label>
              </div>
              <div class="form-check">
                <label class="form-check-label">
                  <input type="radio" name="nol3{{ $item->id }}[]" class="change-radio-ajax" data-id="{{ $item->id }}" data-table="items" data-column="nol3" value="no" @if($item->nol3 == 'no') checked @endif> no
                </label>
              </div>
            </td>
            <td>
...
@include('layouts.admin.form.form-preview-block', ['title' => 'Slide', 'name' => 'preview', 'value' => NULL, 'file_type' => 'file'])
...
@include('layouts.admin.form.form-textarea', ['title' => 'shot Description', 'name' => 'text2',  'value' => NULL])

@include('layouts.admin.form.form-input', ['title' => 'Price', 'name' => 'nol1', 'languages' => false])
