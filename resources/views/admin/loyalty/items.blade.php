...
@include('layouts.admin.header', ['title' => 'Карта лояльности', 'content' => 'Создание логики для карты лояльности'])
...
@include('layouts.admin.form.form-input', ['title' => 'Заголовок', 'name' => 'title', 'value' => NULL])

@include('layouts.admin.form.form-input', ['title' => 'Процент', 'name' => 'nol1', 'languages' => false])

@include('layouts.admin.form.form-input', ['title' => 'Количество покупок', 'name' => 'nol2', 'languages' => false])

@include('layouts.admin.form.form-input', ['title' => 'Сумма покупок', 'name' => 'nol3', 'languages' => false])
