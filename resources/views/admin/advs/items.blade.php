...
@include('layouts.admin.header', ['title' => 'Преимущества', 'content' => 'Блок преимуществ внизу главной страницы'])
...
@include('layouts.admin.form.form-input', ['title' => 'Класс иконки', 'name' => 'nol1', 'value' => NULL, 'languages' => false])

@include('layouts.admin.form.form-input', ['title' => 'Title', 'name' => 'title', 'value' => NULL])

@include('layouts.admin.form.form-textarea', ['title' => 'Описание', 'name' => 'text1', 'value' => NULL])

@include('layouts.admin.form.form-input', ['title' => 'Ссылка', 'name' => 'nol2', 'value' => NULL, 'languages' => false])
